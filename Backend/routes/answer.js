...
router.get("/answers", (req, res) => {
  ...
  console.log("query bdy", req.body.test);

  const answersFields = {};

  if (req.query.question) answersFields.question = req.query.question;
  if (req.user._id) answersFields._id = req.user._id;

  answersFields.answer = "abc";
  answersFields.isAnnonymous = "true";

  console.log("fields ans", answersFields);
  Model.find(answersFields)
